...
<body>
    <div class="checkout">
                            ...
                            <li class="header__navbar-item header__navbar-user"> 
                                ...
                                <ul class="header__navbar-user-menu" >
                                    ...
                                    <c:if test="${sessionScope.acc.roleid == 3}" >
                                        ...
                                        <li class="header__navbar-user-item">
                                            <a href="add.account">Quản lý tài khoản</a>
                                        </li>
                                    </c:if>
        ...
        <div  class="container-checkout container">
            ...
            <div class="box-checkout checkout-form" style="width: 32.334%;">
                ...
                <form action="showcheckout" method="post" class="checkout-input-group">
                    ...
                    <div class="checkout-input-field">
                        <input required class="input-box" value="${accd.email}" type="text" placeholder="...@gmail.com" name="logEmail">
                        <label for="logEmail">Email:</laDebel>
                    </div>
                    <div class="checkout-input-field">
                        <input required class="input-box" value="${accd.phone}" type="number" name="logPhone">
            ...
            <form action="showcheckout" method="get" id="checkoutForm" style="display: flex">
                <!-- checkout delivery  -->
                <div  class="box-checkout checkout-delivery" style="width: 50%">
                    <div>
                        <div class="checkout-form-title" >
                            <span> <i class="fa-solid fa-truck"></i> Vận chuyển  </span>
                        </div>
                        <div class="checkout-delivery-box">
                            <input required id="input3" type="radio" name="delivery" value="ship" ${delivery == "ship" ? 'checked': ''} class="checkout-input__radio">
                            <div class="checkout-flex">
                        ...
                        <div class="checkout-delivery-box">
                            <input required id="input4" type="radio" name="delivery" value="noship" ${delivery == "noship" ? 'checked': ''} class="checkout-input__radio">
                            <div class="checkout-flex">
                    ...
                    <div>
                        ...
                        <div class="checkout-delivery-">
                            ...
                            <div class="checkout-delivery-box">
                                <input required id="input2" type="radio" id="input2"  ${type == 1 ? 'checked': ''} onchange="submitForm()" class="checkout-input__radio" name="type_checkout" value="1">
                                <div class="checkout-flex">
                ...
                <div class="box-checkout checkout-product" style="padding-right: 0; width: 50%;">
                    ...
                    <div class="checkout-product-total">
                        ...
                        <div class="checkout-flex checkout-money">
                            ...
                            <span>₫${delivery == 'ship' ? "40.000": "0"}</span>
                        </div>
