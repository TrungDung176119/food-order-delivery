...
public class SearchServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Product> listPbyCondition = pdao.searchProductsByCondition(null, null, cateid);
        if (cateid != null && sortBy != null) {
            listPbyCondition = pdao.searchProductsByCondition(null, sortBy, cateid);
        }
        if (action != null && action.equals("search")) {
            listPbyCondition = pdao.searchProductsByCondition(keyword, null, cateid);
        }
        if (action != null && sortBy != null) {
            listPbyCondition = pdao.searchProductsByCondition(keyword, sortBy, null);
        }
