...
//        AccountDAO adao = new AccountDAO();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String logImage = request.getParameter("avatar");
...
//                    boolean update = AccountDAO.gI().editProfile(ConstAccount.ACTION_UPDATE, acc.getAccid(), logName.trim(), avatar, logEmail, logPhone, gender, dob);
                    if (update) {
