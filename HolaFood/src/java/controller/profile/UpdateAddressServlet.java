...
public class UpdateAddressServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        int address_id = Integer.parseInt(addressIdString);
        AccountDAO adao = new AccountDAO();
        AccountAddress acca = adao.getAccAddressByAddressId(address_id);
        List<AccountAddress> acca2 = adao.getAccAddressByid(acc.getAccid());
        request.setAttribute("AccAddr", acca);
        request.setAttribute("addresses", acca2);
