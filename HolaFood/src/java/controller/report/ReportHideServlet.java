 ...
 * @author Dung
 */
@WebServlet(name = "ReportHideServlet", urlPatterns = {"/reportHide"})
public class ReportHideServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (pid == null || pid.isEmpty()) {
            ...
            ManagerProDAO.gI().manageProduct("HIDE", Integer.parseInt(pid), 0, 0, null, null, 0, 0, 0, 0, "Vi phạm", null, 0);
            boolean RequestState = ReportDAO.gI().UpdateRequest(1, acc.getAccid(), Integer.parseInt(request_id));
            ms = RequestState ? "Ẩn sản phẩm thành công." : "Có lỗi xảy ra. Vui lòng thực hiện lại.";
        }
