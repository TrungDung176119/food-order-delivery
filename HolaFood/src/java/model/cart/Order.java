...
public class Order {
    ...
    public Order(int order_id, int acc_id, String username, String phone, String email, String address, String note, Timestamp order_date, int discount, int total_price) {
        this.order_id = order_id;
        this.acc_id = acc_id;
        this.username = username;
        this.phone = phone;
