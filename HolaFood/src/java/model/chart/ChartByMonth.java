...
public class ChartByMonth {
    ...
    public ChartByMonth(int month1, int month2, int month3, int month4, int month5, int month6, int month7, int month8, int month9, int month10, int month11, int month12) {
        this.month1 = month1;
        this.month2 = month2;
        this.month3 = month3;
        this.month4 = month4;
    ...
    public String toString() {
        return "ChartByMonth{" + "month1=" + month1 + ", month2=" + month2 + ", month3=" + month3 + ", month4=" + month4 + ", month5=" + month5 + ", month6=" + month6 + ", month7=" + month7 + ", month8=" + month8 + ", month9=" + month9 + ", month10=" + month10 + ", month11=" + month11 + ", month12=" + month12 + '}';
    }
