            ...
            <div class="cart-with-search">
                <div class="grid cart-search">
                    ...
                    <form action="search" method="get" class="cart__header-search">
                        <input class="cart__header-search-input" type="text" name="keyword" name="action"
                            ...
                            <div class="cart-product-amount-box">
                                <div class="cart-product-amount">
                                    <button type="button" class="cart-product-amount__btn">
                                        <a href="process?number=-1&pid=${i.product.pid}" style="padding: 4px"><i class="fa-solid fa-minus"></i></a>
                                    </button>
                                    <input type="text" class="cart-product-amount__num" value="${i.quantity}" />
                                    <button type="button" class="cart-product-amount__btn">
                                        <a href="process?number=1&pid=${i.product.pid}"style="padding: 4px"><i class="fa-solid fa-plus"></i></a>
                                    </button>
                                </div>
