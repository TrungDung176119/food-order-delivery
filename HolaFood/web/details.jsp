                ...
                <div class="container">
                    <div class="app__details-header row">
                        ...
                        <div class="app__details-header-describe col-md-7 col-sm-7 col-lg-7 ">
                            ...
                            <a href="addReport?pid=${detail.pid}"><button onclick="openReportModal()">
                        ...
                        <div class="page__shop-left flex">
                            ...
                            <div class="page__shop-infor">
                                ...
                                <div class="flex page__shop-infor__btn">
                                    ...
                                    <a href="shoppage?sid=${seller.seller_id}&cateid=${detail.category.id}&suggestid=${detail.category.id}" class="btn__white page__shop-btn-visit">
