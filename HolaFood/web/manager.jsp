                ...
                <div class="grid">
                    <div class="home__container-main">
                        <div class="home__main-header">
                            ...
                            <div class="home__header-mesage-del" style="margin-right: 120px">
                                <span>${ms}</span>
                            </div>
                            <c:if test="${acc != null && acc.roleid ==2}">
                        ...
                        <form action="searchPro" method="post" class="order-menu__filter" style="margin: 20px 26px ;">
                            <button type="submit"style="background: transparent; border: none" >
                                <i class="fa-solid fa-magnifying-glass" style="margin-top: 0"></i>
                            </button>
                            <input type="text" name="query" class="order-menu__filter-input" placeholder="Tìm kiếm sản phẩm theo tên">
                        </form>

                        <div class="header-address__list" style="margin: 0 0 18px 26px;height: 38px">
                            <select class="header-address__select" id="categorySelect" onchange="redirectToServlet(this)" style="position: unset; margin-right: 8px ">
                                <option value="all">Tất cả thể loại hàng</option>
                                <c:forEach items="${listC}" var="o">
                                    <option value="${o.id}">${o.name}</option>
                                </c:forEach>
                            </select>
                            <select class="header-address__select" id="categorySelect2" onchange="redirectToServlet(this)"style="position: unset">
                                ...
                                <div class="home__controll-main" style=" margin-bottom: 40px;">
                                    ...
                                    <table style="max-width: 100%; width: 100%;">
                                        <tr class="table__product-title">
                                            <th>
                                                <div class="table__product-title-id"> ID</div>
                                            </th>
                                            <th>
