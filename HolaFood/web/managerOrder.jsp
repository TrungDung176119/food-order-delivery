                    ...
                    <div class="manage__order">
                        ...
                        <div class="manage__order-container">
                            <div class="manage__order-option">
                                <form action="exportexel" method="get" class="manage__order-export flex">
                                    <span class="manage__order-export-title">Ngày đặt hàng</span>
                                    <input name="dateStart" title="Ngày bắt đầu cần tìm " type="date" pattern="\d{2}-\d{2}-\d{4}"
                                           class="manage__order-export-date">&nbsp;
                                    <i class="fa-solid fa-minus" style="color: #989898; font-size: 1.2rem"></i>&nbsp;
                                    <input name="dateEnd" type="date" class="manage__order-export-date" title="Ngày cuối cần tìm">
                                    <button type="submit" class="btn__white manage__order-export-btn">Xuất</button>
                                </form>
