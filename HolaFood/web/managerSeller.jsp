                    ...
                    <div class="home__container-main" style="margin-top: 44px; padding-top:1px ;">
                        <div class="manage__seller-menu-tabs">
                            <nav class="manage__seller-menu flex ">
                                ...
                                <a href="managerSeller?is_active=-3" class="manage__seller-menu-link ${tag_page == -3? "manage__seller-menu-link--active":""}">
                                    <span class="manage__seller-menu-name">Đã hủy (${deny})</span>
                                </a>
                            </nav>
                        </div>
                        <%--<c:if test="${tag_page == 2 || tag_page == null}">--%>
                        <form action="managerSeller" method="get" class="order-menu__filter" style="margin: 20px 26px;">
                            <input type="hidden" value="${tag_page}" name="is_active" />
                        ...
                        <div class="home__main-header" style="padding: 0;">
                            <div class="manage__seller-head-title">
                                <h4>Tổng ${total_seller} cửa hàng </h4>
                            </div>
                            <c:if test="${ms != null}">
                                ...
                                <c:forEach items="${listSeller}" var="s">
                                    <form  action="managerSeller" method="post">
                                        ...
                                        <tr class="manage__seller-table-container">
                                            <td>
                                                <a href="shoppage?sid=${s.seller_id}&&cate=1&&suggestid=1" class="manage__seller-table-id"> #${s.seller_id} </a>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <c:if test="${s.is_active == 0}" >
                                                    <div class="table__product-action">
                                                        <input type="submit" name="action" value="Accept" class="manage__order-btn change-input-to-link"  />
                                                        <a href="#reason-deny-${s.seller_id}" class="manage__orcder-btn" >Deny</a>
                                                    </div> 
                                                </c:if>
                                                ...
                                                <c:if test="${s.is_active == -2}">
                                                    <div class="table__product-action">
                                                        <input type="submit" name="action" value="Unhide" class="manage__order-btn change-input-to-link"/>
                                                        <a href="managerSeller?is_active=${tag_page}#reason-hide-${s.seller_id}" class="manage__order-btn " style="">Reason</a>
                                                    </div> 
                                                </c:if>
                                                <c:if test="${s.is_active == -3}" >
                                                    <div class="table__product-action">
                                                        <a href="#" class="manage__orcder-btn" style="cursor: no-drop; color: #a7a7a7">Denied</a>
                                                        <a href="managerSeller?is_active=${tag_page}#reason-deny-${s.seller_id}" class="manage__order-btn" style="">Reason</a>
                                                    </div> 
                                                </c:if>
                                            </td>
                                        </tr> 
                                        ...
                                        <div class="dialog overlay" id="reason-deny-${s.seller_id}">
                                            <div class="dialog-body">
                                                <span class="dialog-body-reason__title"><i class="fa-regular fa-bell" style="font-size: 1.9rem; margin-right: 4px"></i>  Lý Do Từ Chối Cửa Hàng #${s.seller_id}</span>
                                                <div>
                                                    <textarea name="reason-deny" maxlength="200" class="dialog__order-reason__input" placeholder="Điền tại đây..">${s.note}</textarea>
                                                </div>
                                        ...
                                        <div class="dialog overlay" id="reason-hide-${s.seller_id}">
                                            <div class="dialog-body">
                                                ...
                                                <div>
                                                    <textarea name="reason-hide" maxlength="200" class="dialog__order-reason__input" placeholder="Điền tại đây..">${s.note}</textarea>
                                                </div>
                                                <div class="flex" style="justify-content: flex-end;">
                                                    <c:if test="${s.is_active != -2}" >
                        ...
                        <div  class="filter__pagination">
                            ...
                            <div class="manager-filter__paging" >
                                <c:if test="${tag > 1}">
                                    <a href="managerSeller?is_active=${tag_page}&index=${tag-1}" class="home-filter__paging-btn">
                                        <i class="page-icon fas fa-angle-left"> </i>
                                        <span>Prev</span>
                                    </a>
                                </c:if>
                                <div class="select-input" style="width: auto">
                                    <c:forEach begin="1" end="${endP}" var="i">
                                        <a class="select-input__link" style="margin: 0 12px" href="managerSeller?is_active=${tag}&index=${i}"> ${i}</a>
                                    </c:forEach>
                                </div>
                                <c:if test="${tag < endP}">
                                    <a href="managerSeller?is_active=${tag_page}&index=${tag+1}" class="home-filter__paging-btn">
