            ...
            <div class="container__profile ">
                <div class="grid">
                    ...
                    <jsp:include page="profile_menu.jsp"></jsp:include> 
                        ...
                        <form action="profile" method="post" class="profile__right-content" style="margin-top: 25px;">
                            ...
                            <div class="profile__right-pic" id="imageForm" enctype="multipart/form-data">
                                ...
                                <input class="btn__light" value="Chọn Ảnh" name="avatar" style="min-width: 84px;box-shadow: 0 1px 4px 0 rgba(0,0,0,0.09);" type="file" onclick="document.getElementById('imageInput').click();" />
