...
<div class="sidebar">
    <ul class="sidebar-menu">
        ...
        <c:if test="${sessionScope.acc.roleid == 3}" >
            ...
            <li class="sidebar-item">
                <i class="sidebar-item__icon fas fa-flag"></i>
                <a href="managerReport" class="sidebar-item__title" >Quản Lý Đơn Tố Cáo</a>
            </li>
        </c:if>
        <c:if test="${sessionScope.acc.roleid == 2}" >
            ...
            <li class="sidebar-item">
                ...
                <a href="chart" class="sidebar-item__title">Biểu đồ</a>
            </li>
        </c:if>

        <li class="sidebar-item">
            <img class="sidebar-item__icon" src="https://cf.shopee.vn/file/09759afab8ae066ca5e1630bc19133a1" alt="Dữ Liệu">
            <a href="dbproduct" class="sidebar-item__title">Dữ Liệu</a>
        </li>
        
        <li class="sidebar-item">
            <img class="sidebar-item__icon" src="https://cf.shopee.vn/file/09759afab8ae066ca5e1630bc19133a1" alt="Dữ Liệu">
            <a href="dashboard-manager" class="sidebar-item__title">Biểu đồ</a>
        </li>
        <li class="sidebar-item">
